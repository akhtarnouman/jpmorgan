...
$(document).ready(function() {
	...
	$('#example tbody td').editable("dbupdate.php",{ "onblur": 'submit' ,submitdata:function(value,settings){
	 var aPos = oTable.fnGetPosition( this );
	return{"colName":aPos[1]};}}); /* Submit the form when bluring a field */	
	/* Init DataTables */
