...
if($number_of_rows==0)
	...
	print"<div align=\"center\"><button class=\"button button-submit\" onclick=\"location.href ='register.php?eid=".$employer_id."&id=".$id."';\" >REGISTER</button></div>";
}
?>
</body>
</html>
